...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_ROMI_ROVER
  // Grbl generic default settings. Should work across different machines.
  #define DEFAULT_X_STEPS_PER_MM 40.0
  #define DEFAULT_Y_STEPS_PER_MM 40.0
  #define DEFAULT_Z_STEPS_PER_MM 268.0
  #define DEFAULT_X_MAX_RATE 8000.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 8000.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION 200.0
  #define DEFAULT_Y_ACCELERATION 200.0
  #define DEFAULT_Z_ACCELERATION 20.0
  #define DEFAULT_X_MAX_TRAVEL 640.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 640.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_HOMING_DIR_MASK 7 // move negative dir
  #define DEFAULT_HOMING_FEED_RATE 25.0 // mm/min
